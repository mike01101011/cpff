							...
							<?php if( get_field('overview') ): ?> <!-- start loop -->
								<div class="shorts clearfix">
									...
									<!-- <div class="short-films"> -->
												...
												<!-- </div> /.short-film	 -->
									<!-- </div> /.short-films -->
									<p>Stranded in Christie Pits! is co-curated by Emily Reid and Felan Parker.</p>
								</div> <!-- /.shorts -->
							<?php endif; ?> <!-- end loop -->
...
<!-- <pre><?php print_r($image);?></pre> -->
									...
									<?php endif; ?>
									<p>design credit José Garcia of <a href="http://www.garciadesign.ca/">Garcia Design</a></p>
								</div> <!-- /.poster -->
							<?php endif; ?> <!-- end loop -->
